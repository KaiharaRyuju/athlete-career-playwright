...
(async () => {
  ...
  // await page.goto(
  //   "https://athlete-career.mynavi.jp/careerschool-app-contact/",
  //   {
  //     timeout: 60000,
  //   }
  // );
  ...
  await page.goto(
    "https://stg-athlete-career.mynavi.jp/careerschool-app-contact/",
    {
      timeout: 60000,
    }
  );
